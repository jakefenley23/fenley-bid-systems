    ...
    <div className="min-h-screen bg-white text-slate-950">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <a href="mailto:fenleybidsystems@gmail.com" className="hidden rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-blue-950/30 transition hover:bg-blue-500 md:inline-flex">Schedule a Consultation</a>
        </div>
      </header>
      ...
      <main id="home">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-24 lg:grid-cols-[1.05fr_0.95fr] lg:py-32">
            <div>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <a href="mailto:fenleybidsystems@gmail.com" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-blue-600 px-7 py-4 font-bold text-white shadow-xl shadow-blue-950/30 transition hover:bg-blue-500">
              ...
              <div className="rounded-[1.5rem] bg-slate-900 p-6">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-2xl bg-white p-5 text-slate-950">
                    ...
                    <p className="mt-2 text-sm text-slate-500">Captured this month</p>
                  </div>
                  <div className="rounded-2xl bg-white p-5 text-slate-950">
                    <p className="text-sm font-semibold text-slate-500">Follow-Ups</p>
                    <p className="mt-2 text-4xl font-black">18</p>
                    <p className="mt-2 text-sm text-slate-500">Automated tasks</p>
                  </div>
        ...
        <section id="about" className="bg-white px-6 py-20">
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.25em] text-blue-600">About Fenley Bid Systems</p>
              <h2 className="mt-3 text-4xl font-black uppercase tracking-tight md:text-5xl">Practical systems for serious business growth.</h2>
            </div>
            <div className="space-y-5 text-lg leading-8 text-slate-600">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {["Professional presentation", "Lead-focused systems", "Operational organization", "Growth-minded execution"].map((item) => (
                  <div key={item} className="flex items-center gap-3 rounded-2xl bg-slate-50 p-4 font-semibold text-slate-900">
        ...
        <section id="contact" className="bg-slate-950 px-6 py-20 text-white">
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black uppercase tracking-tight md:text-5xl">Let’s build something that drives growth.</h2>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">Schedule a consultation to discuss your business goals and see how Fenley Bid Systems can help your company operate smarter and grow faster.</p>
            </div>
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-8 shadow-2xl">
              <div className="space-y-5">
                <a href="mailto:fenleybidsystems@gmail.com" className="flex items-center gap-4 rounded-2xl bg-white p-5 font-bold text-slate-950 transition hover:bg-blue-50">
                  <Mail className="h-6 w-6 text-blue-600" /> fenleybidsystems@gmail.com
                </a>
                <a href="tel:8327553203" className="flex items-center gap-4 rounded-2xl bg-white p-5 font-bold text-slate-950 transition hover:bg-blue-50">
                  <Phone className="h-6 w-6 text-blue-600" /> (832) 755-3203
                </a>
                <div className="flex items-center gap-4 rounded-2xl bg-white p-5 font-bold text-slate-950">
                  <MapPin className="h-6 w-6 text-blue-600" /> Serving businesses nationwide
                </div>
                <a href="mailto:fenleybidsystems@gmail.com?subject=Consultation Request - Fenley Bid Systems" className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-7 py-4 font-black text-white transition hover:bg-blue-500">
                  Schedule a Consultation <ArrowRight className="h-5 w-5" />
                </a>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl border-t border-white/10 pt-10">
          <div className="grid gap-10 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="mt-4 max-w-md text-sm leading-6 text-slate-400">Professional systems. Measurable growth.</p>
            </div>
            <div>
              <h4 className="font-black uppercase tracking-wide">Solutions</h4>
              <div className="mt-4 space-y-2 text-sm text-slate-400">
                <p>Websites</p>
                <p>Lead Generation</p>
                <p>CRM & Automation</p>
                <p>Proposal Systems</p>
              </div>
            </div>
            <div>
